    ...
    <main className={styles.main}>
      <section className={Introstyles.introduction}>
        ...
        <div className={Introstyles.infogrid}>
          <a href="https://nextjs.org/docs" className={`${Introstyles.infocard} ${Introstyles.one}`}>
            <h3>$1000 in prizes &rarr;</h3>
          </a>

          <a href="https://nextjs.org/learn" className={`${Introstyles.infocard} ${Introstyles.two}`}>
            <h3>36 Hours &rarr;</h3>
          </a>
          <a href="https://nextjs.org/learn" className={`${Introstyles.infocard} ${Introstyles.three}`}>
