...
async function generateGroupPromise(payload, dispatch) {
  try {
    const requestURL = "https://cms.citrushack.com/groups";
    //Request auth
    dispatch(startFetching());
    const response = await request(requestURL, {
      method: "POST",
...
async function refreshPromise(payload, dispatch) {
  try {
    const requestURL = "https://cms.citrushack.com/users/getmygroup";
    dispatch(startFetching());
    const response = await request(requestURL, {
      method: "GET",
    });
...
async function refreshStatusPromise(payload, dispatch) {
  try {
    const requestURL = "https://cms.citrushack.com/users/getmystatus";
    dispatch(startFetching());
    const response = await request(requestURL, {
      method: "GET",
    });
